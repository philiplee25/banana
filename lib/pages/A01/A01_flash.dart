...
class A01_flash extends StatefulWidget {
  const A01_flash({Key? key}) : super(key: key);

  @override
  _A01_flashState createState() => _A01_flashState();
}

class _A01_flashState extends State<A01_flash> {
